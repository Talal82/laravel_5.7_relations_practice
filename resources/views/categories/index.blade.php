        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a class="btn btn-primary" href="{{ route('categories.create') }}"><i class="fa fa-plus"></i> New</a>
                </div>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('categories.edit', [ $category -> id ]) }}" class="btn btn-primary btn-sm pull-left waves waves-effect" style="margin-right: 5px;" title="Edit"><i class="fa fa-wrench" title="Edit"></i></a>
...
<script>
  var url = 'delete-multiple-categories';
</script>
